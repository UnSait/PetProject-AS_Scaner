...
function DescriptionContainer() {    
    ...
    <section className='description-container'>
        <div className='description-container__discription'>
            ...
            <p className='description-container__text'> Большая просьба давать обратную связь по опыту использования приложением, оставлять свои предложения и замечания (контакты указаны ниже).</p>
        </div>
        <Link to='/regions'>
