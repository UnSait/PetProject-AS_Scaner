...
function DescriptionContainer() {    
    ...
    <section className='description-container'>
        <div className='description-container__discription'>
            ...
            Полученный результат обновляет сохраненный ранее список AS и при следующем запросе актуальный список AS будет сравниваться с ним. Обработка данных регионов, где зарегистрировано большое количество AS, может идти несколько минут.</p>
